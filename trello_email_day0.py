...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#D1D1D1;padding:24px 16px;">
  <tr>
    <td align="center">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width:680px;border-radius:18px;overflow:hidden;background:linear-gradient(180deg,#535353,#535353);border:4px solid #000000;box-shadow:1 18px 45px #000000;">
        <tr>
